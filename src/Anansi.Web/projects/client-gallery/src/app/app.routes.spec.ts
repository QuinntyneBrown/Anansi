...
describe('Client Gallery Routes', () => {
  ...
  it('should have gallery/:collectionId route', () => {
    const route = routes.find((r) => r.path === 'gallery/:collectionId' && r.loadComponent);
  ...
  it('should have gallery base route', () => {
  ...
  it('should lazy-load GalleryHomePageComponent for gallery/:collectionId', async () => {
    const route = routes.find((r) => r.path === 'gallery/:collectionId' && r.loadComponent);
